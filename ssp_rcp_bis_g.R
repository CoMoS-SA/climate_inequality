...
if(top20_ineq==F){
  ginis_all<-read_csv(paste0("data_revision/ginis_all_ssp_",ssps[i_ssp],"_rcp_",rcps[i_rcp],".csv"))
  ...
  gini_for_fig<-as.data.frame(gini_for_fig)%>%mutate(Scenario=paste0("SSP",ssps[i_ssp], " RCP",rcps[i_rcp]," - Global - Prec"))
  ginis_all<-rbind(ginis_all,gini_for_fig) }

if(top20_ineq==T){
  gini_for_fig<-cbind(ginis$initial[1], ginis$mean_final[1], ginis$se_fin[1])
  colnames(gini_for_fig)<-c("Gini initial", "Gini mean final", "SE")
  gini_for_fig<-as.data.frame(gini_for_fig)%>%mutate(Scenario=paste0("SSP",ssps[i_ssp], " RCP",rcps[i_rcp]," - Top20 - Prec"))
...
if(top20_ineq==F){
  gini_for_fig<-cbind(ginis$initial[1], ginis$mean_final[1], ginis$se_fin[1])
  colnames(gini_for_fig)<-c("Gini initial", "Gini mean final", "SE")
  gini_for_fig<-as.data.frame(gini_for_fig)%>%mutate(Scenario=paste0("SSP",ssps[i_ssp], " RCP",rcps[i_rcp]," - Global - Prec+Temp"))
...
if (top20_ineq==T){
  gini_for_fig<-cbind(ginis$initial[1], ginis$mean_final[1], ginis$se_fin[1])
  colnames(gini_for_fig)<-c("Gini initial", "Gini mean final", "SE")
  gini_for_fig<-as.data.frame(gini_for_fig)%>%mutate(Scenario=paste0("SSP",ssps[i_ssp], " RCP",rcps[i_rcp]," - Top20 - Prec+Temp"))
